                ...
                <form name="frmdelete">
                    <table class="table table-boardered">
                        <tr>
                            ...
                            <td><input type="text" class="intext" id="inputId" name="vid" value="${memberVO.vid}" readonly="readonly" /></td>
                        </tr>

                        <tr>
                            <th style="color: gray;">패스워드</th>
                            <td><input type="password" class="intext" name="vpassword" placeholder="변경할 비밀번호를 입력해주세요"></td>
                        </tr>
...
function check() {
	...
	var vpassword = '<c:out value="${memberVO.vpassword}"/>';

	console.log(vpassword);
	
    //비밀번호 일치 유효성

    if(document.frmdelete.vpassword.value != vpassword){
    ...
    frmdelete.action = "/vendor/delete";
    frmdelete.submit();
