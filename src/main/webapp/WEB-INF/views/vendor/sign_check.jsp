    ...
    <div class="container sub-layout">
        ...
        <div class="join-agree-layout">
            <div class="jumbotron" align="center">
                <h1>A.L.T</h1>
                <hr>
                <p><b>업체가입 약관 및 개인정보 처리방침 안내 동의</b></p>
            </div>
            <div class="row" align="left">
                <div class="col-sm-6" style="margin: 0 auto;">
                    <form name='nJoin' role="form" id="joinForm" action="/sign_vendor" method="post" autocomplete="off" onSubmit="return check()">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group align-middle">
                                    <label class="control-label"><b>1. 업체가입 약관</b></label>
                                    <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="checkbox pull-right">
                                            <label for="join_user_agree">
                                                <input type="checkbox" name="join_user_agree" id="join_user_agree" value="1" /> 업체가입 약관에 동의합니다.
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-footer">
                                ...
                                <div style="overflow: hidden">
                                    <div class="text-center" style="margin: 0 auto;">
                                            <button class="btn btn-success btn-lg" type="submit">업체 가입</button>
                                    </div>
                                </div>
                            </div>
                        </div>
