...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<form name="frmSignup" action="/vendor/login" method="post">
				<img src="/resources/sorc/img/avatar.svg">
				<h2 class="title" >ALT 업체 로그인</h2>
            	...
            	<a href="/sign_check_vendor"><input type="button" class="btn" value="아직 가입을 안하셨나요?"></a>
