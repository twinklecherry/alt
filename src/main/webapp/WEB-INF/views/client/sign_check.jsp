        ...
        <div class="join-agree-layout">
            ...
            <div class="row" align="left">
                <div class="col-sm-6" style="margin: 0 auto;">
                    <form name='nJoin' role="form" id="joinForm" action="/sign_client" method="post" autocomplete="off" onSubmit="return check()">
                            ...
                            <div class="panel-footer">
                                ...
                                <div style="overflow: hidden">
                                    <div class="text-center" style="margin: 0 auto;">
                                            <button class="btn btn-success btn-lg" type="submit">회원 가입</button>
                                    </div>
                                </div>
                            </div>
                        </div>
