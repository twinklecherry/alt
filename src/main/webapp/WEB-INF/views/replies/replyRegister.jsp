...
<script src="https://kit.fontawesome.com/3929e16ef5.js"></script>
			...
			<div class="basket row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
              			<label style="font-weight:bold; font-size:20px;">가격</label><br>
            		...
            		<div class="form-group">
              			<label style="font-weight:bold; font-size:20px;">남은 수량</label><br>
              			<span style="font-size: medium;"><fmt:formatNumber value="${sale.samount }" pattern="###,###"/>개</span>
              			<input type="hidden" value='${sale.samount }'>
            		</div>
            		<hr>
            		<div class="form-group">
              			<label style="font-weight:bold; font-size:20px;">상세 설명</label>
	...
	<section>
		<div class="container">
			<form id="frmRegister" action="/replies/new" method="post" >
				<div class="form-group">
					<p id="star_grade" style="color: orange;">
           		...
           		<div class="form-group">
             		<!-- <label>작성자</label>  -->
             		<input class="form-control" type="text" name="rwriter" value='${ memberVO.cid}' readonly="readonly">
           		</div>
				<div class="form-group">
             		<!-- <label>내용</label>  -->
             		<textarea id="rcontent" class="form-control" rows="10" name='rcontent' placeholder="제품의 리뷰를 작성해주세요."></textarea>
           		</div>
...
<script type="text/javascript">
			...
			$.getJSON("/board/getThumbList", {snoStr: snoStr}, function(arr) {
				...
				$(arr).each(function(i, attach) { 
					...
					str = "<div data-path='" + attach.stuploadPath + "' data-uuid='" + attach.stuuid + "' data-filename='" + attach.stfileName + "' data-type='" + attach.stfileType + "'>"
						+  "	<div>"
						+  "		<img  style='max-width: 350px; max-height: 350px; width: 100%; height: 100%;' src='/display?fileName=" + fileCallPath + "'>"
						+  "	</div>"
						+  "</div>";
	...
	$("#btnSubmit").on("click", function(e){
		...
		var str = "";
	 	...
	 	var star = $('.fas').length;
		str += "<input type='hidden' name='rstar' value='" + star + "'>";
