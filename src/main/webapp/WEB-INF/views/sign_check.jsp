        ...
        <div class="join-agree-layout">
            ...
            <div class="row" align="left">
                <div class="col-sm-6" style="margin: 0 auto;">
                    <form name='nJoin' role="form" id="joinForm" method="post" autocomplete="off" onSubmit="return check()">
                            ...
                            <div class="panel-footer">
                                ...
                                <div style="overflow: hidden">
                                    <div class="col-sm-offset-3 col-sm-6" style="margin: 0 auto;">
                                        <a href="/sign_client" style="color: white;">
                                            <button class="inbutton" type="button">회원 가입</button>
                                            
                                        </a>
                                        <a href="/sign_vendor" style="color: white;">
                                        	<button class="inbutton" type="button">업체 가입</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
